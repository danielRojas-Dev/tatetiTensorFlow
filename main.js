...
const circulo = document
  .getElementById("circulo")
  .addEventListener("click", () => {
    eligeFicha("o");
  });

const equis = document.getElementById("equis").addEventListener("click", () => {
  eligeFicha("x");
});

document.getElementById("ceroCero").addEventListener("click", (e) => {
  const objeto = e.target;

  jugadaHumano(objeto, 0, 0);
});

document.getElementById("ceroUno").addEventListener("click", (e) => {
  const objeto = e.target;

  jugadaHumano(objeto, 0, 1);
});

document.getElementById("ceroDos").addEventListener("click", (e) => {
  const objeto = e.target;

  jugadaHumano(objeto, 0, 2);
});

document.getElementById("unoCero").addEventListener("click", (e) => {
  const objeto = e.target;

  jugadaHumano(objeto, 1, 0);
});

document.getElementById("unoUno").addEventListener("click", (e) => {
  const objeto = e.target;

  jugadaHumano(objeto, 1, 1);
});
document.getElementById("unoDos").addEventListener("click", (e) => {
  const objeto = e.target;

  jugadaHumano(objeto, 1, 2);
});

document.getElementById("dosCero").addEventListener("click", (e) => {
  const objeto = e.target;

  jugadaHumano(objeto, 2, 0);
});
document.getElementById("dosUno").addEventListener("click", (e) => {
  const objeto = e.target;

  jugadaHumano(objeto, 2, 1);
});
document.getElementById("dosDos").addEventListener("click", (e) => {
  const objeto = e.target;

  jugadaHumano(objeto, 2, 2);
});
